...
m_PenWidth = 2           ; Width of the pen to draw trails with.
m_NodePenWidth = 2       ; Radius of "nodes" on the trails, indicating where each stroke begins.
m_PenColor = ff0000            ; Colour of trails and nodes.
